...
| **javax** | `boot-jdk8-javax` (Spring Boot 2.7) | ✅ Growth-32 (sales), ⚠️ Growth-47 (customer fresh scaffold — L1+L2+L4-빌드 PASS, L4-probe FAIL: T-Probe-LaneRunner-Mismatch → fix Growth-48) | JAVA_HOME=JDK17, target=1.8 (JDK8 부재 시 우회); Growth-46 G-Jackson 픽스 적용 후 fresh-scaffold 종단검증 시도 |
